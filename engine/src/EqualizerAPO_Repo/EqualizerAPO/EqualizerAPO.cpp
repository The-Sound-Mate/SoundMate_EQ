...
const CRegAPOProperties<1> EqualizerAPO::regPostMixProperties(EQUALIZERAPO_POST_MIX_GUID, L"SoundMate",
	L"Copyright (C) 2026", 1, 0, __uuidof(IAudioProcessingObject),
	(APO_FLAG) (APO_FLAG_FRAMESPERSECOND_MUST_MATCH | APO_FLAG_BITSPERSAMPLE_MUST_MATCH | APO_FLAG_INPLACE));
const CRegAPOProperties<1> EqualizerAPO::regPreMixProperties(EQUALIZERAPO_PRE_MIX_GUID, L"SoundMate",
	L"Copyright (C) 2026", 1, 0, __uuidof(IAudioProcessingObject),
	(APO_FLAG) (APO_FLAG_FRAMESPERSECOND_MUST_MATCH | APO_FLAG_BITSPERSAMPLE_MUST_MATCH | APO_FLAG_INPLACE));
